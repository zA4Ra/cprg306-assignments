  ...
  return (
    <main className="p-6">
      ...
      <ul className="space-y-2">
        ...
        <li>
          <Link href="/week-6" className="text-white-600 underline">
          Week 6
          </Link>
        </li>
        <li>
          <Link href="/week-7" className="text-white-600 underline">
          Week 7
          </Link>
        </li>
        <li>
          <Link href="/week-8" className="text-white-600 underline">
          Week 8
          </Link>
        </li>
      </ul>
